                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label for="title" class="col-md-3 control-label myRequired">نام نقش مدیریتی
                                    (انگلیسی):</label>
                                <div class="col-md-9">
                                    <input disabled maxlength="190" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="help-block myHelpBlock">نمیتوانید ویرایش کنید</span>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="md-checkbox">
                                                    <input type="checkbox" id="checkbox{{$i}}" name="permission[]"
                                                           value="{{$permission->name}}" @if(in_array($permission->id,$role_permissions_id)) checked @endif class="md-check">
