                ...
                @if(!$data['categories']->isEmpty())
                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal form-label-stripped"
                              action="{{route("admin.article.store")}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="link" maxlength="190" name="link" type="text"
                                               ...
                                               placeholder="example: http://google.com" value="https://google.com">
                                        {{--<span class="help-block">این فیلد قبل ویرایش نیست.</span>--}}
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    @include('admin.developer.component.back_to_list',['model'=>'news','method'=>'index'])
